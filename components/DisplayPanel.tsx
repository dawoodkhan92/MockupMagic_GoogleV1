...
export const DisplayPanel: React.FC<DisplayPanelProps> = (props) => {
    ...
    return (
        <div className="bg-white p-6 rounded-xl border border-zinc-200 flex flex-col gap-4">
            <div className="relative w-full h-full bg-zinc-100 rounded-lg flex items-center justify-center p-4 aspect-square">
            ...
            {generatedImage && !isLoading && (
              <div className="flex flex-col gap-4">
                {finalPromptForDisplay && (
                  <div className="p-4 rounded-xl border border-zinc-200">
                    <div className="flex justify-between items-center mb-2">
                        <h4 className="text-md font-bold text-zinc-800">Final Prompt</h4>
                        {!isEditingPrompt && (
                            <button 
                    ...
                    {isEditingPrompt ? (
                        <>
                            <textarea
                                ...
                                className="w-full p-2 border border-zinc-300 rounded-md focus:ring-2 focus:ring-zinc-400 transition bg-white text-sm"
                                rows={4}
                            />
                            <div className="flex items-center gap-2 mt-2">
                                <button
                                    ...
                                    className="flex-grow bg-zinc-700 text-zinc-50 font-semibold py-2 px-4 rounded-lg flex items-center justify-center transition-colors disabled:bg-zinc-300 disabled:text-zinc-500 disabled:cursor-not-allowed hover:bg-zinc-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 focus-visible:ring-offset-2"
                                >
                                    Regenerate with this Prompt
                                </button>
                                <button
                                    onClick={handleCancelEditClick}
                                    className="flex-shrink-0 border border-zinc-300 bg-white text-zinc-900 font-semibold py-2 px-4 rounded-lg transition-colors hover:bg-zinc-100"
                                >
                                    Cancel
                                </button>
                            </div>
                ...
                <div className="p-4 rounded-xl border border-zinc-200">
                  <h4 className="text-md font-bold mb-2 text-zinc-800">Refine Scene</h4>
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-full p-2 border border-zinc-300 rounded-md focus:ring-2 focus:ring-zinc-400 transition bg-white"
                    ...
                    <button
                      ...
                      className="bg-zinc-900 text-zinc-50 font-semibold px-4 py-2 rounded-md transition-colors hover:bg-zinc-800 disabled:bg-zinc-300 disabled:text-zinc-500 disabled:cursor-not-allowed flex-shrink-0"
                    ...
                    <button
                      ...
                      disabled={!canUndo}
                      className="border border-zinc-300 bg-white p-2 rounded-md transition-colors hover:bg-zinc-100 disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  {Object.keys(suggestedRefinements).length > 0 && (
                     <div className="mt-4 flex flex-col gap-3">
                        <p className="text-xs text-zinc-600 font-medium -mb-1">Need ideas? Click to add to your refinement:</p>
                ...
                <button
                    ...
                    className="w-full border border-zinc-300 bg-white text-zinc-900 font-bold py-3 px-4 rounded-lg flex items-center justify-center transition-colors hover:bg-zinc-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 focus-visible:ring-offset-2"
                >
                    <DownloadIcon/>
                    Download Image
                </button>
